...
class ConfirmShipmentTests extends TestCase{
        ...
        public function testGetLabel(){
          ...
          $this->assertSame("http://127.0.0.1:3002/ship/2950364/labels/06df987f0d2ef55d19da283baebaa12771e46a8f?document=reg",$this->confirmShipment->getLabel());
        }
        ...
        public function testGetThermalLabel(){
          ...
          $this->assertSame("http://127.0.0.1:3002/ship/2950364/labels/06df987f0d2ef55d19da283baebaa12771e46a8f?document=therm",$this->confirmShipment->getThermalLabel());
        }
        ...
        protected function setUp(){
            $response = '{
               ...
               "labels":{
                  "regular":"http:\/\/127.0.0.1:3002\/ship\/2950364\/labels\/06df987f0d2ef55d19da283baebaa12771e46a8f?document=reg",
                  "thermal":"http:\/\/127.0.0.1:3002\/ship\/2950364\/labels\/06df987f0d2ef55d19da283baebaa12771e46a8f?document=therm"
               },
               "packages":[
                  {
                     "width":22,
